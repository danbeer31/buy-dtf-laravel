...
class AccountController extends Controller
{
    ...
    public function downloadImage(DtfImage $image): BinaryFileResponse
    {
        ...
        $filename = $image->image_name ?: basename($absolutePath);
        $pathExtension = pathinfo($absolutePath, PATHINFO_EXTENSION);
        $nameExtension = pathinfo($filename, PATHINFO_EXTENSION);
